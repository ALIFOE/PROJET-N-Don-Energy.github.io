<div {{ $attributes->merge(['class' => "bg-gradient-to-br from-{$color}-500 to-{$color}-600 rounded-xl p-6 text-white shadow-lg transform hover:scale-105 transition-transform"]) }}>
