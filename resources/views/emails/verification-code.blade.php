...
<body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background: #f9f9f9; padding: 20px; border-radius: 5px;">
        ...
        <p>Merci de vous être inscrit sur CREFER. Pour finaliser votre inscription, veuillez utiliser le code de vérification suivant :</p>
        ...
        <p style="color: #666; margin-top: 30px;">Cordialement,<br>L'équipe CREFER</p>
    </div>
</body>
</html>
